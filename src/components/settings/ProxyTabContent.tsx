...
import { DeepSeekProxySettings } from "@/components/settings/DeepSeekProxySettings";
        ...
        >
          <AccordionTrigger className="px-6 py-4 hover:no-underline hover:bg-muted/50 data-[state=open]:bg-muted/50">
            <div className="flex items-center gap-3">
              ...
              <div className="text-left">
                <h3 className="text-base font-semibold">
                  {t("settings.advanced.deepseekProxy.title", {
                    defaultValue: "DeepSeek 本地代理",
                  })}
                </h3>
                <p className="text-sm text-muted-foreground font-normal">
                  {t("settings.advanced.deepseekProxy.description", {
                    defaultValue:
                      "启动本地协议转换代理，让 Codex CLI 通过 DeepSeek 模型运行",
                  })}
                </p>
              </div>
            </div>
